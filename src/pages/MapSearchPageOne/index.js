  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins justify-end mx-[auto] w-[100%]">
        ...
        <Row className="items-center lg:ml-[27px] xl:ml-[31px] 2xl:ml-[35px] 3xl:ml-[42px] mr-[auto] lg:mt-[38px] xl:mt-[44px] 2xl:mt-[49px] 3xl:mt-[59px] w-[66%]">
          <Text className="font-medium lg:text-[26px] xl:text-[30px] 2xl:text-[34px] 3xl:text-[41px] text-black_900 tracking-ls1 w-[auto]">
            Start
          </Text>
          <Text className="bg-gray_100 font-semibold lg:ml-[28px] xl:ml-[32px] 2xl:ml-[36px] 3xl:ml-[43px] lg:pl-[26px] xl:pl-[29px] 2xl:pl-[33px] 3xl:pl-[40px] xl:pt-[11px] 2xl:pt-[12px] 3xl:pt-[14px] lg:pt-[9px] rounded-radius10 lg:text-[23px] xl:text-[27px] 2xl:text-[30px] 3xl:text-[36px] text-black_900 tracking-ls1 w-[350px]">
            Cape Town
          </Text>
        ...
        <Column className="items-center lg:mt-[45px] xl:mt-[52px] 2xl:mt-[58px] 3xl:mt-[70px] lg:px-[11px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] w-[100%]">
          <Row className="w-[99%]">
            ...
            <Text className="bg-gray_100 font-normal lg:ml-[26px] xl:ml-[29px] 2xl:ml-[33px] 3xl:ml-[40px] mt-[1px] not-italic pb-[1px] lg:pt-[4px] 2xl:pt-[5px] xl:pt-[5px] 3xl:pt-[6px] lg:px-[26px] xl:px-[29px] 2xl:px-[33px] 3xl:px-[40px] rounded-radius10 lg:text-[26px] xl:text-[30px] 2xl:text-[34px] 3xl:text-[41px] text-black_900 tracking-ls1 w-[226px]">
              -
            </Text>
        ...
        <Column className="items-end lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:px-[13px] xl:px-[15px] 2xl:px-[17px] 3xl:px-[20px] w-[100%]">
          <Button
            className="font-semibold lg:text-[23px] xl:text-[27px] 2xl:text-[30px] 3xl:text-[36px] text-center tracking-ls1 w-[20%]"
            shape="RoundedBorder10"
            size="md"
            variant="FillBlue900"
          >
        ...
        <Column className="items-center lg:mt-[14px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] pl-[3px] w-[100%]">
          <Img
            src="images/img_rectangle14_7X1497.png"
            className="xl:h-[6px] lg:h-[6px] 2xl:h-[7px] 3xl:h-[9px] w-[100%]"
            alt="RectangleFourteen"
          />
        </Column>
        <Button
          className="common-pointer font-semibold lg:ml-[15px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] xl:mr-[1006px] 2xl:mr-[1132px] 3xl:mr-[1358px] lg:mr-[880px] lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] lg:text-[23px] xl:text-[27px] 2xl:text-[30px] 3xl:text-[36px] text-center tracking-ls1 w-[20%]"
        ...
        <Column className="items-center lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] lg:pr-[5px] xl:pr-[6px] 2xl:pr-[7px] 3xl:pr-[9px] w-[100%]">
          <List className="gap-[0] min-h-[auto] w-[99%]" orientation="vertical">
            <Stack className="lg:h-[614px] xl:h-[702px] 2xl:h-[789px] 3xl:h-[947px] lg:my-[5px] xl:my-[6px] 2xl:my-[7px] 3xl:my-[9px] w-[100%]">
              <Stack className="absolute bg-bluegray_100 lg:h-[611px] xl:h-[699px] 2xl:h-[786px] 3xl:h-[943px] lg:px-[11px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] rounded-bl-[20px] rounded-br-[20px] rounded-tl-[10px] rounded-tr-[20px] top-[0] w-[100%]">
                <Img
                  ...
                  className="common-pointer absolute bottom-[0] lg:h-[466px] xl:h-[533px] 2xl:h-[599px] 3xl:h-[719px] inset-x-[0] mx-[auto] rounded-radius20 w-[98%]"
          ...
          <Text className="font-semibold lg:mt-[26px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[41px] lg:text-[23px] xl:text-[27px] 2xl:text-[30px] 3xl:text-[36px] text-black_900 tracking-ls1 w-[auto]">
            End of Results
          </Text>
          <footer className="bg-bluegray_100 lg:mt-[126px] xl:mt-[144px] 2xl:mt-[162px] 3xl:mt-[194px] rounded-radius20 w-[99%]">
...
export default MapSearchPageOnePage;
