  ...
  return (
    <>
      ...
      >
        ...
        <aside className="absolute bottom-[0] items-center justify-end left-[0] w-[26%]">
          <Column className="">
            <Column className="bg-white_A700 justify-center lg:p-[4px] 2xl:p-[5px] xl:p-[5px] 3xl:p-[6px] rounded-bl-[32px] rounded-br-[16px] rounded-tl-[16px] rounded-tr-[16px] w-[100%]">
              ...
              <Line className="bg-indigo_A700 h-[1px] lg:mb-[1102px] xl:mb-[1261px] 2xl:mb-[1418px] 3xl:mb-[1702px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[8px] xl:mt-[9px] w-[97%]" />
            </Column>
          </Column>
        </aside>
      </Stack>
