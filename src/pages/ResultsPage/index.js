...
const ResultsPagePage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins mx-[auto] lg:pb-[523px] xl:pb-[598px] 2xl:pb-[673px] 3xl:pb-[808px] w-[100%]">
        ...
        <Button
          className="common-pointer font-semibold lg:ml-[15px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] lg:text-[23px] xl:text-[27px] 2xl:text-[30px] 3xl:text-[36px] text-center tracking-ls1 w-[20%]"
        ...
        <Column className="items-center lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] lg:px-[5px] xl:px-[6px] 2xl:px-[7px] 3xl:px-[9px] w-[100%]">
          <List
            className="gap-[0] min-h-[auto] w-[100%]"
            orientation="vertical"
          >
            <Column
              className="common-pointer bg-bluegray_100 items-center justify-end lg:my-[4px] 2xl:my-[5px] xl:my-[5px] 3xl:my-[6px] lg:p-[11px] xl:p-[13px] 2xl:p-[15px] 3xl:p-[18px] rounded-radius20 w-[100%]"
          ...
          <footer className="bg-bluegray_100 xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] rounded-radius20 w-[100%]">
